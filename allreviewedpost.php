...
include("connection.php");
  $sql = "SELECT * FROM rproduct WHERE recommandto ='".$_SESSION['user']."'"; 
  ...
  ?>
    <tbody>
      <tr>
        ...
        <td>View topic</td>
        <td><a href="allreviewedpost1.php?productname=<?php echo $productname ?>">view</a></td>
      </tr>
	  <?php 
  }
  mysqli_close($link);
