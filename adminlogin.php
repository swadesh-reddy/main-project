...
<!--header-->
 ...
 <h2 align="center"><font color="white">Collaborative Filtering-Based Recommendation of Online Social Voting</font></h2>
 	...
 	<div class="container">
<form class="col-md-offset-3 col-md-5 col-sm-12 col-xs-12"  action="adminlogins.php" method="POST" >
 <h2 class="col-md-offset-4" style="letter-spacing: 2px;font-family: sans-serif;text-align: justify;">ADMIN LOGIN</h2><br>
